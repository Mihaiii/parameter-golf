...
class Hyperparameters:
    ...
    tversky_num_features = _e("TVERSKY_NUM_FEATURES", 128, int)
    tversky_feature_pools = _e("TVERSKY_FEATURE_POOLS", 1, int)
    ...
    corr_weight_lr = _e("CORR_WEIGHT_LR", 0.02, float)
    smear = _e("SMEAR", 0, bool)
    seq_len_start = _e("SEQ_LEN_START", 0, int)
    seq_schedule_fraction = _e("SEQ_SCHEDULE_FRACTION", 0, float)
